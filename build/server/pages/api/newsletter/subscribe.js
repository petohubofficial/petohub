...
const handler = async (req, res)=>{
    ...
    try {
        ...
        let newsletter = await models_Newsletter__WEBPACK_IMPORTED_MODULE_0__/* ["default"].findOne */ .Z.findOne({
            email: req.body.email
        });
        // Create a new listing
        if (!newsletter) newsletter = await models_Newsletter__WEBPACK_IMPORTED_MODULE_0__/* ["default"].create */ .Z.create({
            email: req.body.email
        });
...
var __webpack_exports__ = __webpack_require__.X(0, [4035], () => (__webpack_exec__(417)));
